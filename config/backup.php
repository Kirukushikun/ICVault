    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Just the pool export written by `vault:backup` — the sqlite
                    // database itself is already dumped below via 'databases'.
                    // Bundling the whole codebase (the package default) makes no
                    // sense for a personal single-user app.
                    storage_path('app/private/backup-exports'),
                ],
